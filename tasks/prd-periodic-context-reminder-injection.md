...
**Acceptance Criteria:**
- [ ] `ReminderConfig` dataclass added to `archon/config/loader.py` with fields: `enabled: bool = True`, `interval_messages: int = 20`, `interval_tokens: int = 40000`, `notify: bool = False`
