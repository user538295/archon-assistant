...
- `[reminder] enabled` (default `true`); `interval_messages` (default `20`), `interval_tokens` (default `40000`) — OR thresholds, whichever is reached first triggers injection. Notifications shown automatically in verbose/debug mode
