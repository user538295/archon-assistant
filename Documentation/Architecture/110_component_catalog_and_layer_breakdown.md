...
**Responsibility**: Orchestrates all layers in a single asyncio event loop; owns startup sequencing, Search server probing, and graceful shutdown.
...
3. Optionally probe Search server
...
- [120 Services and Integration Architecture](120_services_and_integration_architecture.md) — External integration details for Telegram, Claude SDK, MCP, Search, and daemon
